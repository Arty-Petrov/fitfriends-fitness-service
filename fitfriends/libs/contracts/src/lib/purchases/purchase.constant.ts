import { PaymentMethod, ProductType, SortOrder, TrainingDuration } from '@fitfriends/shared-types';
...
export const PurchaseApiError = {
  ...
  QuantityIsNotValid: `Quantity must be in range ${PurchaseQuantityRange.Min}, max ${PurchaseQuantityRange.Max}`,
